...
from pgan_torch_v3 import AdaptiveStageGAN
import torch
...
def main_gan_v2(station, max_image_shape, cp_dir=None, lr=0.001, batch_size=None,
    ...
    gan = StageGAN(files_dir=files_dir,
                   ...
                   decoder_filters_list=[128, 128, 128, 64, 32, 16],
                   cp_dir=cp_dir,
                   epochs_per_phase=100,
                   info_lambda=0.01,
                   grad_lambda=10,
...
def main_gan_v3(station, max_image_shape, cp_dir=None, lr=0.001, batch_size=None,
    ...
    code_features = 10
    noise_features = latent_features - code_features
    gan = AdaptiveStageGAN(files_dir=files_dir,
                           code_features=code_features, noise_features=noise_features,
                           embedding_dim=2048,
                           cp_dir=cp_dir,
                           epochs_per_phase=100,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--v", dest="v", type=int,
                        choices={1, 2, 3}, default=2, required=False, help="1 - gan, 2 - gan v2, 3 - gan v2 with adaptive architecture")
    ...
    parser.add_argument("--batch_size", "--bs", type=int, dest="bs",
                        required=False, default=None, help="batch size")
